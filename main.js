...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _assets_styles_style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assets/styles/style.scss */ \"./src/assets/styles/style.scss\");\n/* harmony import */ var _scripts_keyboard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scripts/keyboard */ \"./src/scripts/keyboard.js\");\n/* harmony import */ var _scripts_realKeyboardHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/realKeyboardHandler */ \"./src/scripts/realKeyboardHandler.js\");\n/* harmony import */ var _scripts_virtualKeyboardHandler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/virtualKeyboardHandler */ \"./src/scripts/virtualKeyboardHandler.js\");\n\n\n\n\n\nif (localStorage.getItem('layout') == null || localStorage.getItem('layout') === 'eng') {\n  _scripts_keyboard__WEBPACK_IMPORTED_MODULE_1__.keyboard.node.classList.add('layout-eng');\n  window.localStorage.setItem('layout', 'eng');\n}\nif (localStorage.getItem('layout') === 'ru') {\n  _scripts_keyboard__WEBPACK_IMPORTED_MODULE_1__.keyboard.node.classList.add('layout-ru');\n  window.localStorage.setItem('layout', 'ru');\n}\n\n_scripts_keyboard__WEBPACK_IMPORTED_MODULE_1__.keyboard.node.addEventListener('mousedown', _scripts_virtualKeyboardHandler__WEBPACK_IMPORTED_MODULE_3__.mouseDownHandler);\n_scripts_keyboard__WEBPACK_IMPORTED_MODULE_1__.keyboard.node.addEventListener('mouseup', _scripts_virtualKeyboardHandler__WEBPACK_IMPORTED_MODULE_3__.mouseUpHandler);\n\nwindow.addEventListener('keydown', _scripts_realKeyboardHandler__WEBPACK_IMPORTED_MODULE_2__[\"default\"]);\nwindow.addEventListener('keyup', _scripts_realKeyboardHandler__WEBPACK_IMPORTED_MODULE_2__[\"default\"]);\n\n\n//# sourceURL=webpack://virtual-keyboard/./src/index.js?");

/***/ }),

/***/ "./src/scripts/changeText.js":
/*!***********************************!*\
  !*** ./src/scripts/changeText.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ changeText)\n/* harmony export */ });\n/* harmony import */ var _keyboard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./keyboard */ \"./src/scripts/keyboard.js\");\n\n\nfunction changeText(key, langSwitch) {\n  let keyPrint = '';\n  let positionStart = _keyboard__WEBPACK_IMPORTED_MODULE_0__.textarea.node.selectionStart;\n  let positionEnd = _keyboard__WEBPACK_IMPORTED_MODULE_0__.textarea.node.selectionEnd;\n  let capsLock = false;\n  if (document.querySelector('.caps-lock') !== null) capsLock = true;\n  if (key.type === 'Symbol') {\n    keyPrint = langSwitch === 'eng' ? key.downEng : key.downRu;\n    keyPrint = capsLock ? keyPrint.toUpperCase() : keyPrint;\n    if (document.querySelector('.shift-left') !== null || document.querySelector('.shift-right') !== null) {\n      if (langSwitch === 'eng') {\n        if (key.upEng) keyPrint = key.upEng;\n        else keyPrint = key.downEng.toUpperCase();\n      } else {\n        if (key.upRu) keyPrint = key.upRu;\n        keyPrint = key.downRu.toUpperCase();\n      }\n    }\n  } else {\n    switch (key.code) {\n      case 'Tab':\n        keyPrint = '\\t';\n        break;\n      case 'Space':\n        keyPrint = ' ';\n        break;\n      case 'Backspace':\n        if (_keyboard__WEBPACK_IMPORTED_MODULE_0__.textarea.node.value.length\n          && positionStart === positionEnd) positionStart -= 1;\n        break;\n      case 'Enter':\n        keyPrint = '\\n';\n        break;\n      case 'Delete':\n        if (positionStart === positionEnd) positionEnd += 1;\n        break;\n      case 'ArrowLeft':\n        if (positionStart) {\n          positionStart -= 1;\n          positionEnd = positionStart;\n        }\n        break;\n      case 'ArrowRight':\n        if (positionEnd < _keyboard__WEBPACK_IMPORTED_MODULE_0__.textarea.node.value.length) {\n          positionEnd += 1;\n          positionStart = positionEnd;\n        }\n        break;\n      case 'ArrowUp':\n        keyPrint = key.down;\n        break;\n      case 'ArrowDown':\n        keyPrint = key.down;\n        break;\n      default:\n    }\n  }\n  _keyboard__WEBPACK_IMPORTED_MODULE_0__.textarea.node.setRangeText(keyPrint, positionStart, positionEnd, 'end');\n}\n\n\n//# sourceURL=webpack://virtual-keyboard/./src/scripts/changeText.js?");
...
/***/ "./src/scripts/realKeyboardHandler.js":
/*!********************************************!*\
  !*** ./src/scripts/realKeyboardHandler.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ keyboardHandler)\n/* harmony export */ });\n/* harmony import */ var _keys__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./keys */ \"./src/scripts/keys.js\");\n/* harmony import */ var _changeText__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./changeText */ \"./src/scripts/changeText.js\");\n/* harmony import */ var _keyboard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./keyboard */ \"./src/scripts/keyboard.js\");\n/* harmony import */ var _switchLang__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./switchLang */ \"./src/scripts/switchLang.js\");\n\n\n\n\n\nfunction keyboardHandler(event) {\n  let langSwitch = window.localStorage.getItem('layout');\n  const pressedKey = _keys__WEBPACK_IMPORTED_MODULE_0__[\"default\"].flat().find((el) => el.code === event.code);\n  if (!pressedKey) return;\n  event.preventDefault();\n  const virtualKey = document.querySelector(`#${pressedKey.code}`);\n  if (event.type === 'keydown') {\n    virtualKey.classList.add('active');\n    (0,_changeText__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(pressedKey, langSwitch);\n    _keyboard__WEBPACK_IMPORTED_MODULE_2__.textarea.node.focus();\n    if (event.code === 'ShiftLeft') {\n      _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.add('shift-left');\n      document.querySelector('#ShiftRight').classList.remove('active');\n    }\n    if (event.code === 'ShiftRight') {\n      _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.add('shift-right');\n      document.querySelector('#ShiftLeft').classList.remove('active');\n    }\n    if (event.key === 'CapsLock') {\n      if (document.querySelector('.caps-lock') === null) {\n        _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.add('caps-lock');\n      } else {\n        _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.remove('caps-lock');\n        virtualKey.classList.remove('active');\n      }\n    }\n    if (event.code === 'AltLeft' && document.querySelector('.shift-left') !== null) {\n      (0,_switchLang__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(langSwitch);\n      langSwitch = window.localStorage.getItem('layout');\n\n      document.querySelector('#ShiftLeft').classList.remove('active');\n      _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.remove('shift-left');\n    }\n  } else {\n    if (event.key !== 'CapsLock') virtualKey.classList.remove('active');\n    if (event.key === 'Shift') {\n      _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.remove('shift-left');\n      _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.remove('shift-right');\n    }\n  }\n}\n\n\n//# sourceURL=webpack://virtual-keyboard/./src/scripts/realKeyboardHandler.js?");

/***/ }),

/***/ "./src/scripts/switchLang.js":
/*!***********************************!*\
  !*** ./src/scripts/switchLang.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ switchLanguage)\n/* harmony export */ });\n/* harmony import */ var _keyboard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./keyboard */ \"./src/scripts/keyboard.js\");\n\n\nfunction switchLanguage() {\n  let langSwitch = window.localStorage.getItem('layout');\n  langSwitch = langSwitch === 'eng' ? 'ru' : 'eng';\n  window.localStorage.setItem('layout', langSwitch);\n  if (langSwitch === 'eng') {\n    _keyboard__WEBPACK_IMPORTED_MODULE_0__.keyboard.node.classList.remove('layout-ru');\n    _keyboard__WEBPACK_IMPORTED_MODULE_0__.keyboard.node.classList.add('layout-eng');\n  } else {\n    _keyboard__WEBPACK_IMPORTED_MODULE_0__.keyboard.node.classList.remove('layout-eng');\n    _keyboard__WEBPACK_IMPORTED_MODULE_0__.keyboard.node.classList.add('layout-ru');\n  }\n}\n\n\n//# sourceURL=webpack://virtual-keyboard/./src/scripts/switchLang.js?");

/***/ }),

/***/ "./src/scripts/virtualKeyboardHandler.js":
/*!***********************************************!*\
  !*** ./src/scripts/virtualKeyboardHandler.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"mouseDownHandler\": () => (/* binding */ mouseDownHandler),\n/* harmony export */   \"mouseUpHandler\": () => (/* binding */ mouseUpHandler)\n/* harmony export */ });\n/* harmony import */ var _keys__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./keys */ \"./src/scripts/keys.js\");\n/* harmony import */ var _changeText__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./changeText */ \"./src/scripts/changeText.js\");\n/* harmony import */ var _keyboard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./keyboard */ \"./src/scripts/keyboard.js\");\n/* harmony import */ var _switchLang__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./switchLang */ \"./src/scripts/switchLang.js\");\n\n\n\n\n\nlet langSwitch = window.localStorage.getItem('layout');\n\nfunction mouseDownHandler(event) {\n  const pressedKey = event.target.closest('.key');\n  if (!pressedKey) return;\n  event.preventDefault();\n  pressedKey.classList.add('active');\n  const virtualKey = _keys__WEBPACK_IMPORTED_MODULE_0__[\"default\"].flat().find((el) => el.code === pressedKey.id);\n  langSwitch = window.localStorage.getItem('layout');\n  (0,_changeText__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(virtualKey, langSwitch);\n  _keyboard__WEBPACK_IMPORTED_MODULE_2__.textarea.node.focus();\n\n  if (pressedKey.id === 'AltLeft') {\n    if (document.querySelector('.shift-left') !== null) {\n      (0,_switchLang__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(langSwitch);\n      langSwitch = window.localStorage.getItem('layout');\n    }\n  }\n  if (pressedKey.id === 'CapsLock') {\n    if (document.querySelector('.caps-lock') === null) {\n      _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.add('caps-lock');\n    } else {\n      _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.remove('caps-lock');\n      pressedKey.classList.remove('active');\n    }\n  }\n\n  if (pressedKey.id === 'ShiftLeft') {\n    _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.remove('shift-right');\n    document.querySelector('#ShiftRight').classList.remove('active');\n    if (document.querySelector('.shift-left') !== null) {\n      _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.remove('shift-left');\n      pressedKey.classList.remove('active');\n    } else {\n      _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.add('shift-left');\n    }\n  } else if (pressedKey.id === 'ShiftRight') {\n    _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.remove('shift-left');\n    document.querySelector('#ShiftLeft').classList.remove('active');\n    if (document.querySelector('.shift-right') !== null) {\n      _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.remove('shift-right');\n      pressedKey.classList.remove('active');\n    } else {\n      _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.add('shift-right');\n    }\n  } else {\n    if (document.querySelector('.shift-left') !== null) {\n      _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.remove('shift-left');\n      document.querySelector('#ShiftLeft').classList.remove('active');\n    }\n    if (document.querySelector('.shift-right') !== null) {\n      _keyboard__WEBPACK_IMPORTED_MODULE_2__.keyboard.node.classList.remove('shift-right');\n      document.querySelector('#ShiftRight').classList.remove('active');\n    }\n  }\n}\n\nfunction mouseUpHandler(event) {\n  const pressedKey = event.target.closest('.key');\n  if (!pressedKey) return;\n  if (pressedKey.id !== 'ShiftLeft'\n    && pressedKey.id !== 'ShiftRight'\n    && pressedKey.id !== 'CapsLock') pressedKey.classList.remove('active');\n}\n\n\n\n\n//# sourceURL=webpack://virtual-keyboard/./src/scripts/virtualKeyboardHandler.js?");
